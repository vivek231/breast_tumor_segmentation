...
# Testing settings
parser = argparse.ArgumentParser(description='breast tumor segmentation-PyTorch-implementation')
parser.add_argument('--dataset', required=True, help='data')
...
for image_name in image_filenames:
    ...
    save_img(out_img, "result/{}/{}".format(opt.dataset, image_name), shape)
